...
**Concept:**
An agent that analyzes the *timbre* of a sound and generates a compatible preset file for popular synthesizers (e.g., Vital, Serum, or Ableton's Operator/Wavetable).
...
- **Similarity Search:** "Find me a snare that sounds like *this* one but with more high-end."
